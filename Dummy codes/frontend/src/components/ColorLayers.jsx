  ...
  return (
    <div className="color-layers">
      ...
      <p className="layers-description">
        Your image has been separated into {layers.length} color layer{layers.length > 1 ? 's' : ''}. 
        Each layer will be drawn with a different pen. The plotter will pause between layers 
        for you to change the pen.
      </p>
          ...
          <div key={index} className="layer-card">
            <div className="layer-header">
              ...
              <div className="layer-info">
                <h4>Layer {index + 1}: {layer.name}</h4>
            ...
            {layer.stats && (
              <div className="layer-stats">
                ...
                <div className="stat-item">
                  ...
                  <span className="stat-value">{layer.stats.estimatedTime}</span>
                </div>
              </div>
            )}
          </div>
